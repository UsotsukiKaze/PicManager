...
def test_anonymous_shell_only_eagerly_loads_auth_bootstrap():
    ...
    assert eager_scripts == ["/static/js/auth.js?v=20260813e"]
...
def test_authenticated_bootstrap_loads_application_only_after_auth_success():
    ...
    for asset in (
        "/static/css/style.css?v=20260813e",
        "/static/js/api.js?v=20260813e",
        "/static/js/ui.js?v=20260813e",
...
def test_page_features_are_lazy_loaded_and_deduplicated():
    ...
    assert "/static/js/upload.js?v=20260813e" in auth_source
